...
// variables to keep track of for jetpack ---------------------------
float upAcc=0;
...
unsigned int createJetpackShadProgram()
{
...
int main()
{
    ...
    glShaderSource(vertexShader, 1, &jetpackVertexShaderSource, NULL);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        unsigned int flyTransLoc=glGetUniformLocation(shaderProgram,"flyTrans");
